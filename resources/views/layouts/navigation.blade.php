<nav x-data="{ open: false }" class="bg-[#fbf6e3] dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('inicio') }}">
                        <x-application-logo class="block h-20 w-auto fill-current rounded-full" />
                    </a>
                </div>
                <!-- Navigation Links -->
