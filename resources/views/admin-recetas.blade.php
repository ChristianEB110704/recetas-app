            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-12">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-wrap -mx-3 mb-6">
                        ...
                        <!-- Recetas Actuales -->
                        <div class="w-full 2xl:w-1/3 px-3 mb-6 md:mb-0 border-r border-gray-300">
                            ...
                            <table class="table-fixed w-full">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border px-4 py-2">{{$receta->categoria}}</td>
                                        <td class="border px-4 py-2">
                                            <a href="/recetas/admin/validar/{{  $receta->id }}" class="bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded">Validar</a>
                                        </td>
                                        <td class="border px-4 py-2">
                                            <a href="/recetas/admin/rsv/{{  $receta->id }}" onclick="return confirm('¿Estás seguro de que deseas eliminar esta receta?')" class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded">Eliminar</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
